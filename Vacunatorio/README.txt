...
a persistence unit "VacunatorioPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Vacunatorio\pom.xml":
...
artifacts ("Vacunatorio-ejb.jar" and "Vacunatorio-web.war") are already built. You can build
