...
public class DatosVacunatorioSchedule extends TimerTask {
    ...
    public void run() {
		...
		try {
			...
			jndiName = "ejb:Vacunatorio/Vacunatorio-ejb/IntervaloRepository!datos.repositorios.IntervaloRepositoryRemote";
			IntervaloRepositoryRemote intervaloRepository = (IntervaloRepositoryRemote)ctx.lookup(jndiName);
			intervaloRepository.drop();
			jndiName = "ejb:Vacunatorio/Vacunatorio-ejb/AgendaRepository!datos.repositorios.AgendaRepositoryRemote";
			AgendaRepositoryRemote agendaRepository= (AgendaRepositoryRemote)ctx.lookup(jndiName);
			agendaRepository.drop();
			jndiName = "ejb:Vacunatorio/Vacunatorio-ejb/EtapaRepository!datos.repositorios.EtapaRepositoryRemote";
			EtapaRepositoryRemote etapaRepository= (EtapaRepositoryRemote)ctx.lookup(jndiName);
			etapaRepository.drop();
			jndiName = "ejb:Vacunatorio/Vacunatorio-ejb/PlanVacunacionRepository!datos.repositorios.PlanVacunacionRepositoryRemote";
			...
			jndiName = "ejb:Vacunatorio/Vacunatorio-ejb/VacunatorioRepository!datos.repositorios.VacunatorioRepositoryRemote";
			...
			loteRepository.drop();
			jndiName = "ejb:Vacunatorio/Vacunatorio-ejb/VacunaRepository!datos.repositorios.VacunaRepositoryRemote";
