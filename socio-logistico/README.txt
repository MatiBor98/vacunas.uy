...
a persistence unit "socio-logisticoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "socio-logistico\pom.xml":
...
artifacts ("socio-logistico-ejb.jar" and "socio-logistico-web.war") are already built. You can build
