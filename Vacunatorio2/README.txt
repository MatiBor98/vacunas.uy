...
a persistence unit "Vacunatorio2PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Vacunatorio2\pom.xml":
...
artifacts ("Vacunatorio2-ejb.jar" and "Vacunatorio2-web.war") are already built. You can build
