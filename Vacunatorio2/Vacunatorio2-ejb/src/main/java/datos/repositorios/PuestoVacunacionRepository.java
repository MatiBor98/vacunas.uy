 ...
 */
@Singleton
public class PuestoVacunacionRepository implements PuestoVacunacionRepositoryLocal, PuestoVacunacionRepositoryRemote {
	...
	@Override
	public void drop() {
		entityManager.createQuery("delete from PuestoVacunacion").executeUpdate();	
		
	}
	
	public void dropAsignaciones() {
		entityManager.createQuery("delete from Asignacion").executeUpdate();	
