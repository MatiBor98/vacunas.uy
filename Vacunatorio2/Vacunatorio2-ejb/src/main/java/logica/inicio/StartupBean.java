...
public class StartupBean {
	...
	public void run() {
		...
		WebTarget target = client.target("https://vacunas.web.elasticloud.uy/rest/vacunatorios/vacunatorio/Hospital_de_Artigas"); 
		...
		props.put(Context.PROVIDER_URL, "http-remoting://vacunas.web.elasticloud.uy/rest/vacunatorios/vacunatorio/Hospital_de_Artigas:80");
