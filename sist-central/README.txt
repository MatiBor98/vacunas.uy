...
a persistence unit "sist-centralPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "sist-central\pom.xml":
...
artifacts ("sist-central-ejb.jar" and "sist-central-web.war") are already built. You can build
