 ...
 * 
 */
@WebServiceClient(name = "ciudadanosService", targetNamespace = "http://webservices.samples.jboss.org/", wsdlLocation = "file:/C:/Users/Administrador/gitIntelliJ/sist-central/sist-central-ejb/src/main/resources/ciudadanos.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/Users/Administrador/gitIntelliJ/sist-central/sist-central-ejb/src/main/resources/ciudadanos.wsdl");
